...
- [Buckaroo](https://github.com/paddymul/buckaroo) - Dataframe viewer for notebook environments.  It adds summary stats, histograms, and search to a fast scrollable table so you can easily see your data by [@paddymul](https://github.com/paddymul)
